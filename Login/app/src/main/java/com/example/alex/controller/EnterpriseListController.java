...
public class EnterpriseListController extends AsyncTask<String, String, String> {
    ...
    public EnterpriseListController(Activity activity) {
    ...
    protected String doInBackground(String... args) {
        ...
        JSONObject json = serverConnection.makeHttpRequestGet(url_all_empresas);
        JSONObject c;
        String id;
        String name;
        HashMap map;
